        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()):
                    ...
                    $query = "SELECT * FROM user_personal_information WHERE student_id='$student_id'";
                    $result_info = mysqli_query($conn, $query);
                    $row_info = mysqli_fetch_assoc($result_info);

                    // Fetch email
                    $email_query = "SELECT email FROM users WHERE student_id='$student_id'";
                    $email_result = mysqli_query($conn, $email_query);
                    $email_row = mysqli_fetch_assoc($email_result);

                    // Fetch Educational Background
                    $edu_query = "SELECT * FROM user_educational_background WHERE student_id='$student_id'";
